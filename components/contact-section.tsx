...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="relative overflow-hidden bg-gradient-to-b from-background via-primary/5 to-background py-20 px-4 md:py-32">
      <div className="mx-auto max-w-4xl">
        ...
        >
          <motion.div className="mb-16 text-center" variants={itemVariants}>
            <h2 className="mb-4 text-4xl font-bold text-balance md:text-5xl">Get In Touch</h2>
              ...
              <div className="space-y-4">
                {[
                  ...
                  >
                    ...
                    <div>
                      <p className="text-sm font-medium text-foreground/70">{contact.label}</p>
